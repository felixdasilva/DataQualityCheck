...
st.write("Subjective Data Quality measures what the users believe to be true. It depends on the user’s prior experience with the data and the task which the data need to solve. Different users looking at the same data set can come to different conclusions on the quality of the data. These are non programmatically measured scores.")
